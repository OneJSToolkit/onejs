...
class View {
  ...
  public static genStyle(defaultStyles: string, styleMap?: string[]): string {
  ...
  public static genClass(defaultClasses: string, classMap?: string[]): string {
  ...
  public static genAttr(defaultAttributes: string, attributeMap: string[]): string {
    var attrString = '';
    var attributes = [];
